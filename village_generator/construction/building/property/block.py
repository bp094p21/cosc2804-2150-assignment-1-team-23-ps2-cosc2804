class Block:
    """Minecraft PI block description w/ slight modifications and custom dictionaries. To be used in
    Minecraft.setBlock/s """
...
# List of usable blocks for building property and house component
# region
AIR = Block(0)
STONE = Block(1)
GRASS = Block(2)
...
STAIRS = [STAIRS_WOOD, STAIRS_COBBLESTONE, STAIRS_BRICK, STAIRS_STONE_BRICK, STAIRS_NETHER_BRICK, STAIRS_SANDSTONE,
          STAIRS_SPRUCE, STAIRS_BIRCH, STAIRS_JUNGLE, STAIRS_QUARTZ, STAIRS_ACACIA, STAIRS_DARK_OAK,
          STAIRS_RED_SANDSTONE, PURPUR_STAIRS]
