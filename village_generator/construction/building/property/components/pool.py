...
class Pool(Component):
    ...
    def __init__(self, line_v3, fill_v3, fence_v3, gate_v3, line_block=b.SANDSTONE, fill_block=b.WATER, fence_block=b.FENCE_ACACIA, gate_block=b.FENCE_GATE_ACACIA, pool_depth=2, line_raise=1, line_depth=1):
