...
class Misc:
    ...
    def place_flowers(self, x, y, z,):
        for i in range(15):
            ...
            self.mc.setBlocks(x + placement_x, y, z + placement_z, x + placement_x, y, z + placement_z, MISC_BLOCKS[self.theme]['flower'])
    
    def place_grass(self,x, y, z):
        for i in range(15):
            placement_x, placement_z = self.random_placement(0, 14)
            self.mc.setBlocks(x + placement_x, y, z + placement_z, x + placement_x, y, z + placement_z, MISC_BLOCKS[self.theme]['shrubs'])       
